		...
		<?php 
			...
			if ($_SERVER['REQUEST_METHOD'] == 'POST') {
				...
				if (empty($formErrors)) {
					...
					if ($count == 1) {
						...
						$stmt->execute(array($user, $email, $name, $pass, $avatar2, $id));
			...
			echo "<div class='container'>";
				...
				if ($check > 0) {
					...
					// Add Notification That The Account Has Been Activated
					$stmt2 = $con->prepare("INSERT INTO notifications(u_id, user_approve) VALUES(:zuid, 1)");
					$stmt2->execute(array('zuid' => $userid));
