										...
										foreach ($comments as $comment) {
											echo '<div class="comment-box">';
												echo '<span class="member-n">
													...
													echo '<div class="buttons-c text-center">';
														echo "<a href='comments.php?do=Edit&comid=" . $comment['c_id'] . "' class='btn btn-success edit'><i class='fa fa-edit'></i> Edit</a>";
														echo "<a href='comments.php?do=Delete&comid=" . $comment['c_id'] . "' class='btn btn-danger confirm delete'><i class='fa fa-close'></i> Delete </a>";
														if ($comment['status'] == 0) {
